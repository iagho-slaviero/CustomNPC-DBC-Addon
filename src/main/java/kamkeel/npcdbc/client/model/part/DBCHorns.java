...
public class DBCHorns extends ModelDBCPartInterface {
    ...
    public DBCHorns(ModelBase par1ModelBase) {
        super(par1ModelBase);
        textureHeight = 32;
        textureWidth = 64;

        // First Form
        this.FirstFormSpikes = new ModelRenderer(par1ModelBase, 0, 0);
        this.FirstFormSpikes.addBox(-0.0F, -0.0F, -0.0F, 0, 0, 0, 0.02F);
        this.FirstFormSpikes.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.spikePairOne = new ModelRenderer(par1ModelBase, 8, 6);
        ...
        this.spikePairTwo = new ModelRenderer(par1ModelBase, 8, 6);
        ...
        this.SecondFormSpikes = new ModelRenderer(par1ModelBase, 0, 0);
        this.SecondFormSpikes.addBox(-0.0F, -0.0F, -0.0F, 0, 0, 0, 0.02F);
        this.SecondFormSpikes.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.spikePairEOne = new ModelRenderer(par1ModelBase, 8, 6);
        ...
        this.spikePairETwo = new ModelRenderer(par1ModelBase, 8, 6);
        ...
        this.bigHeadSpike = new ModelRenderer(par1ModelBase, 16, 6);
        ...
        this.bigHeadSpike2 = new ModelRenderer(par1ModelBase, 16, 6);
        ...
        this.CSpike2 = new ModelRenderer(par1ModelBase, 8, 6);
        ...
        this.CSpike3 = new ModelRenderer(par1ModelBase, 8, 6);
        ...
        this.CSpike4 = new ModelRenderer(par1ModelBase, 8, 6);
        ...
        this.CSpike5 = new ModelRenderer(par1ModelBase, 8, 6);
        ...
        // Namekian Antenna
        (this.NamekianAntennas = new ModelRenderer(par1ModelBase, 0, 0)).addBox(-0.0f, -0.0f, -0.0f, 0, 0, 0, 0.02f);
        this.NamekianAntennas.setRotationPoint(0.0f, 0.0f, 0.0f);
        (this.ant1 = new ModelRenderer(par1ModelBase, 24, 4)).addBox(0.0f, -5.0f, -8.0f, 1, 1, 2);
        this.ant1.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.setRotation(this.ant1, -0.3490659f, -0.4363323f, 0.0f);
        (this.ant2 = new ModelRenderer(par1ModelBase, 24, 4)).addBox(0.0f, -8.533334f, -6.2f, 1, 1, 2);
        this.ant2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.setRotation(this.ant2, 0.2094395f, -0.4364196f, 0.0f);
        (this.ant3 = new ModelRenderer(par1ModelBase, 24, 4)).addBox(-1.0f, -5.0f, -8.0f, 1, 1, 2);
        this.ant3.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.setRotation(this.ant3, -0.3490659f, 0.4363323f, 0.0f);
        (this.ant4 = new ModelRenderer(par1ModelBase, 24, 4)).addBox(-1.0f, -8.533334f, -6.2f, 1, 1, 2);
